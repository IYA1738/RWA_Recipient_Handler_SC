...
contract RecipientHandler is Pausable, Ownable, Nonces{
    ...
    lock
    whenNotPaused {
        uint64 deadline  = order.deadline;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000003,deadline)}
       ...
       bytes32 digest= _hashTypedDataV4(keccak256(
        abi.encode(
            ...
            order.serviceId,
            order.deadline
        )));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000004,digest)}
        ...
        bytes32 quoteDigest = _hashTypedDataV4(keccak256(abi.encode(
            ...
            quote.serviceId,
            quote.expiry
        )));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000005,quoteDigest)}
        address recoveredSeller = quoteDigest.recover(sellerQuoteSig);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000006,recoveredSeller)}
        if (recoveredSeller != quote.seller) revert Errors.NotSeller();

        address boundSeller = serviceToSeller[order.serviceId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000007,boundSeller)}
        if (boundSeller == address(0)) revert Errors.ServiceNotExists();
        if (recoveredSeller != boundSeller) revert Errors.NotSeller();

        bool ok = false;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000008,ok)}
    ...
    ) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00050000, 1037618708485) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00050001, 6) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00051000, buyer) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00051001, paymentToken) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00051002, seller) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00051003, serviceId) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00051004, amount) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00051005, cost) }
        if(buyer == address(0) || paymentToken == address(0) || seller == address(0)){
            revert Errors.ZeroAddress();
        }
        //serviceId ,amount and cost were verified by **payWithEIP712**
        IERC20 token = IERC20(paymentToken);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010009,0)}
        token.safeTransferFrom(buyer, address(this),amount);

        uint256 netProfit =  amount - cost;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000a,netProfit)}
        uint256 commission = Math.mulDiv(netProfit,  commissionRate, 10_000);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000b,commission)}
   ...
   function claim(address token, uint256 claimAmount)external lock{
        ...
        uint256 releasableAmount = sellersProfit[msg.sender][token];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000c,releasableAmount)}
    ...
    function _hashTypedDataV4(bytes32 structHash) internal view returns(bytes32){assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00060000, 1037618708486) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00060001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00061000, structHash) }
        uint256 chainId;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000d,chainId)}
        assembly {
            chainId := chainid()
        }
    ...
    function revokeQuote(PriceQuote calldata quote, bytes calldata sellerQuoteSig) external {
        bytes32 qd = _hashTypedDataV4(keccak256(abi.encode(
            ...
            quote.serviceId,
            quote.expiry
        )));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000e,qd)}
    ...
    function unrevokeQuote(PriceQuote calldata quote, bytes calldata sellerQuoteSig) external {
        bytes32 qd = _hashTypedDataV4(keccak256(abi.encode(
            ...
            quote.serviceId,
            quote.expiry
        )));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000f,qd)}
        require(qd.recover(sellerQuoteSig) == quote.seller, "BadQuoteSig");
        require(msg.sender == quote.seller, "NotQuoteSeller");
    ...
    function setServiceActive(uint128 serviceId) external{
        address serviceOwner = serviceToSeller[serviceId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000010,serviceOwner)}
    ...
    constructor(string memory name, string memory version,address _distributionSC, uint256 _commissionRate) Ownable(msg.sender){
        uint256 chainId;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000011,chainId)}
        assembly{
            chainId := chainid()
        }
