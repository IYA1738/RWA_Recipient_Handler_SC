...
library PermitHelper {
    ...
    function tryPermit2612(address token, address _owner, address _spender, bytes calldata permitData)
        internal
        returns (bool)
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00090000, 1037618708489) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00090001, 5) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00091000, token) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00091001, _owner) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00091002, _spender) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00093003, permitData.offset) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00092003, permitData.length) }
        if (permitData.length < 4) return false;

        bytes4 selector;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000012,selector)}
        assembly {
    ...
    function tryPermit2(bytes calldata permit2Data) internal returns (bool ok) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000a0000, 1037618708490) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000a0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000a3000, permit2Data.offset) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000a2000, permit2Data.length) }
        if (permit2Data.length == 0) return false;
        (ok, ) = PERMIT2.call(permit2Data);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020013,0)}
    }

    /// @dev convenience: ensure allowance or revert
    function ensureAllowanceOrRevert(address token, address owner, address spender, uint256 need) internal view {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000b0000, 1037618708491) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000b0001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000b1000, token) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000b1001, owner) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000b1002, spender) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000b1003, need) }
